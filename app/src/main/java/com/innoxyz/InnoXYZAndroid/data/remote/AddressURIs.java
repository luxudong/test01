...
public class AddressURIs {
    ...
    public static final String HOST = "http://www.innoxyz.com:80";
...
//    passwordOld:11111
//    passwordNew:222222
//    passwordAgain:222222


    public  static  final RequestInfo DOWNLOAD_FILE = new RequestInfo("/file/file","get");
	...
	public static final RequestInfo Calendar_EventId = new RequestInfo("/calendar/get-calendar.action", "get");
	public static final RequestInfo Calendar_Events = new RequestInfo("/calendar/get-events", "get");
	//public static final RequestInfo Calendar_SubEvents = new RequestInfo("/calendar/get-sub-events", "get");
	// public static final RequestInfo Calendar_Events = new RequestInfo("/calendar/get-sub-events?from=2014-01-27T15%3A59%3A59.999Z&to=2015-05-04T15%3A59%3A59.999Z", "get");
	public static	final RequestInfo Calendar_SubEvents = new RequestInfo("/calendar/get-sub-events", "get");
	//public static final RequestInfo Calendar_SubEvents = new RequestInfo("/calendar/get-sub-events?from=2014-01-27T15%3A59%3A59.999Z&to=2015-05-04T15%3A59%3A59.999Z", "get");
}
