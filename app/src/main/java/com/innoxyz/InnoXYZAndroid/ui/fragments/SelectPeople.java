...
import com.innoxyz.InnoXYZAndroid.ui.customviews.NameCardBox;
import com.innoxyz.InnoXYZAndroid.ui.customviews.PeopleGridItem;
import com.innoxyz.InnoXYZAndroid.ui.utils.DataTag;
...
public class SelectPeople extends DialogFragment {
    class PeopleGridViewAdapter extends BaseAdapter {
        ...
        public PeopleGridViewAdapter(Context context) {
            ...
            for(int i=0; i<n; i++) {
                names[i] = "name" + i;
                itemViews[i] = new PeopleGridItem(context);  //To change body of implemented methods use File | Settings | File Templates.
        ...
        @Override
        public int getCount() {
            return names.length;  //To change body of implemented methods use File | Settings | File Templates.
        }
    ...
    public SelectPeople(NameCardBox box) {
        linkedBox = box;
    }
