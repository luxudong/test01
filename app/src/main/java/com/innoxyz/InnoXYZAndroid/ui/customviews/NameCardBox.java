...
import com.innoxyz.InnoXYZAndroid.ui.activities.MainActivity;
import com.innoxyz.InnoXYZAndroid.ui.fragments.SelectPeople;
    ...
    protected void init() {
        ...
        setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                new SelectPeople(NameCardBox.this).show(((MainActivity) getContext()).getFragmentManager(), "select_people");
            }
        });
